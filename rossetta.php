...
<html lang="en">
    <head>
        ...
        <title>Create Rossetta stone</title>
    </head>
    <body>
        ...
        <div class="container">
            <h1>Create Rossetta stone</h1>
            <form method="post">
                <div class="form-group">
                    <label for="text">Rossetta text</label>
        ...
        <div class="container">
            <button type="button" class="btn btn-primary" onclick="print()">Print Rossetta stone</button>
        </div>
        <?php } ?>
    </body>
</html>
